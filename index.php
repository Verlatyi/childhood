                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            ...
                            <?php the_field('feed_back_textarea', 2); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('block_one', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('block_one_descr', 2) ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('contact_with_our', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('mobile_phone_one', 2); ?>"><?php the_field('mobile_phone_one', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('mobile_phone_second', 2); ?>"><?php the_field('mobile_phone_second', 2); ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php 
                                echo do_shortcode('[contact-form-7 id="130" title="Форма отзывов"]');
                            ?>                        
                        </div>
                    </div>
                </div>
